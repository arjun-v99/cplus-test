...
@section('content')
    <div class="row">
        ...
        <div class="col-12 mt-5 d-none" id="financialYearContainer">
            <label for="getYear" class="form-label">Select Year</label>
    ...
    <script>
        function getFinancialYear(countryName) {
            if (countryName) {
                ...
                document.getElementById('financialYearContainer').classList.remove("d-none")
            } else {
                // Hiding Financial Year Container
                document.getElementById('financialYearContainer').classList.add("d-none");
            }
        }
        ...
        function getHolidaysList(yearName) {
            ...
            if (getCountryName) {
                ...
                if (getCountryName === "IE") {
                    $.ajax({
                        url: 'https://date.nager.at/api/v3/PublicHolidays/' + getSelectedYear + '/' +
                            getCountryName,
                        method: 'GET',
                        success: function(data) {
                            ...
                            data.forEach(function(holiday) {
                                ...
                                const node = document.createTextNode(holiday.date + ' - ' + holiday
                                    .localName);
                        ...
                        error: function(jqXHR, textStatus, errorThrown) {
                            console.error('Error fetching holidays:', textStatus, errorThrown);
                            // hiding holiday list
                    ...
                    fyURLs = [
                        'https://date.nager.at/api/v3/PublicHolidays/' + getSelectedYear + '/' +
                        getCountryName,
                        'https://date.nager.at/api/v3/PublicHolidays/' + precedingYear + '/' +
                        getCountryName,
                    ]
                    ...
                    $.when($.getJSON(fyURLs[0]), $.getJSON(fyURLs[1])).done(
                        ...
                        function(data1, data2) {
                            ...
                            const filtered = fyHolidays.filter(h => {
                                ...
                                return d >= fyStart && d <= fyEnd && day !== 0 && day !== 6;
                            });
